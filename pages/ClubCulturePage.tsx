...
const ClubCulturePage: React.FC = () => {
    ...
    return (
        ...
        ------------------------------------------
      */}
            <section className="relative pt-20 pb-24 lg:min-h-[60vh] flex flex-col justify-center overflow-hidden bg-white">
                            ...
                            <div className="flex p-1 bg-slate-100/50 rounded-[1.5rem] overflow-x-auto md:overflow-visible no-scrollbar">
                                {categories.map((cat) => (
                                    <button
                                        ...
                                        className={`px-8 py-3 rounded-[1.2rem] text-sm font-bold transition-all whitespace-nowrap ${activeCategory === cat.id
