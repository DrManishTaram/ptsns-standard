      ...
      <section className="pt-10 pb-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-start relative">
            {/* Vertical Separator (Absolute Center) */}
            ...
            <div className="lg:pl-10 space-y-12">
              ...
              <div>
                ...
                <p className="text-slate-600 text-[15px] leading-[1.8]">
                  To nurture aspiring technologists into ethical leaders who drive innovation and social impact. We are committed to providing a rigorous academic environment that fosters critical thinking, problem-solving, and a deep understanding of computational principles.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-slate-600 text-[15px] leading-[1.8]">
                  To be a globally recognized center of excellence for computer science education and research, producing graduates who are industry-ready and capable of addressing the complex technological challenges of the future.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex p-1.5 rounded-2xl bg-gradient-to-r from-indigo-50 to-violet-50 border border-indigo-100">
              {programs.map((prog, i) => (
                <button
                  ...
                  className={`px-5 py-2.5 rounded-xl text-xs font-bold tracking-wide transition-all duration-300 ${activeProgram === i
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid lg:grid-cols-5 gap-12 max-w-6xl mx-auto items-start">
            ...
            <div className="lg:col-span-3 space-y-3">
              {faqs.map((faq, i) => (
                <div key={i} className={`rounded-2xl border transition-all duration-300 overflow-hidden ${activeFaqIndex === i
                  ...
                  >
                    <span className={`font-bold text-sm transition-colors leading-snug ${activeFaqIndex === i ? 'text-indigo-700' : 'text-slate-700'
                      }`}>{faq.q}</span>
                    <div className={`w-8 h-8 rounded-xl flex items-center justify-center flex-shrink-0 transition-all duration-300 ${activeFaqIndex === i ? 'bg-indigo-600 text-white rotate-180 shadow-md shadow-indigo-200' : 'bg-slate-100 text-slate-400'
                      }`}>
                      <ChevronDown size={14} />
                    </div>
                  </button>
