...
import { ChevronRight, Home, Mail, Phone, ExternalLink, Award, BookOpen, Users, FileText, Quote, Briefcase, Star, ClipboardCheck } from 'lucide-react';

const ExamControllerProfile: React.FC = () => {
    return (
            ...
            <div className="relative bg-[#071133] text-white overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-20">
                    ...
                    <div className="flex items-center gap-2 text-xs text-blue-300 font-medium uppercase tracking-wider pt-6 pb-4">
                        ...
                        <ChevronRight size={12} />
                        <span className="text-white">Exam Controller</span>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row items-center md:items-end gap-6 md:gap-10 pb-20 pt-4">
                        ...
                        <div className="relative flex-shrink-0">
                            <div className="w-40 h-40 md:w-52 md:h-52 rounded-2xl overflow-hidden border-4 border-white/20 shadow-2xl bg-white">
                                <img
                                    src="/coe.png"
                                    alt="Exam Controller Mr. M.K Bhatnagar"
                        ...
                        <div className="text-center md:text-left pb-2">
                            <p className="text-blue-300 text-xs font-bold uppercase tracking-[0.2em] mb-2">Controller of Examinations</p>
                            <h1 className="text-3xl md:text-5xl font-serif font-bold leading-tight">
                                Dr. Mahendra Kishore Bhatnagar
                            </h1>
                            <h2 className="text-xl md:text-2xl font-serif text-white/70 mt-1" style={{ fontFamily: '"Noto Serif Devanagari", serif' }}>
                                डॉ. महेंद्र किशोर भटनागर
                            </h2>
                            <p className="text-blue-200/80 text-sm mt-3 max-w-lg">
                                Controller of Examinations, Pandit Shambhunath Shukla Vishwavidyalaya, Shahdol (M.P.)
                            </p>
                            <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 mt-4">
                                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 text-white/80 text-xs font-medium border border-white/10">
                                    <ClipboardCheck size={12} /> Examinations
                                </span>
                                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 text-white/80 text-xs font-medium border border-white/10">
                    ...
                    <div className="lg:col-span-1 order-2 lg:order-1 space-y-6">
                        ...
                        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                            ...
                            <div className="p-6 space-y-4">
                                <a href="mailto:drmahendrab15@gmail.com" className="flex items-center gap-3 text-gray-600 text-sm hover:text-blue-600 transition-colors group">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-medium">drmahendrab15@gmail.com</p>
                                    </div>
                                </a>
                                <a href="tel:+919425343871" className="flex items-center gap-3 text-gray-600 text-sm hover:text-blue-600 transition-colors group">
                                    <span className="p-2.5 bg-blue-50 rounded-xl text-blue-600 group-hover:bg-blue-600 group-hover:text-white transition-colors">
                                        <Phone size={16} />
                                    </span>
                                    <div>
                                        <p className="text-xs text-gray-400 font-medium">Phone</p>
                                        <p className="font-medium">+91 9425343871</p>
                                    </div>
                                </a>
                                <div className="flex items-center gap-3 text-gray-600 text-sm">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-medium">First Floor, Admin Block, Nawalpur Campus</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                            ...
                            <div className="space-y-3">
                                {[
                                    { label: 'Designation', value: 'Controller of Examinations' },
                                    { label: 'Role', value: 'Exam Administration' },
                                    { label: 'Reports To', value: 'Vice-Chancellor' },
                                    { label: 'Focus', value: 'Evaluations & Results' },
                                ].map((fact, idx) => (
                        ...
                        {/* External Link */}
                        <a
                            href="https://ptsnsu.ac.in/exam-section"
                            target="_blank"
                        ...
                        >
                            <div>
                                <p className="font-bold text-sm">Exam Section</p>
                                <p className="text-blue-200 text-xs mt-0.5">Results & time tables</p>
                            </div>
                    ...
                    <div className="lg:col-span-2 order-1 lg:order-2 space-y-8">
                        ...
                        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 md:p-10">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h2 className="text-2xl font-serif font-bold text-earth-900">About the Exam Controller</h2>
                            </div>
                            <div className="prose prose-gray max-w-none text-gray-600 leading-relaxed space-y-4">
                                <p>
                                    <strong>Dr. Mahendra Kishore Bhatnagar</strong> serves as the Controller of Examinations at Pandit Shambhunath Shukla Vishwavidyalaya, Shahdol (M.P.). In this pivotal role, he oversees the planning, scheduling, and fair conduct of all university examinations.
                                </p>
                                <p>
                                    Responsible for managing the evaluation process and timely declaration of results, Mr. Bhatnagar ensures that the university's academic calendar is strictly adhered to. His commitment to integrity and confidentiality maintains the sanctity of the examination system.
                                </p>
                                <p>
                                    He actively works on modernizing the examination system through the adoption of digital technologies for result processing, student record management, and secure distribution of question papers.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 md:p-10">
                            ...
                            <div className="space-y-4 text-gray-600">
                                <p>The Exam Controller is responsible for the entire examination lifecycle:</p>
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-4">
                                    {[
                                        'Planning exam schedules & centers',
                                        'Paper setting & printing coordination',
                                        'Conducting smooth examinations',
                                        'Central evaluation management',
                                        'Processing & declaring results',
                                        'Issuing marksheets & degrees',
                                    ].map((item, idx) => (
                        ...
                        <div className="bg-gradient-to-br from-[#071133] to-[#0c2157] rounded-2xl shadow-lg p-8 md:p-10 text-white relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <h2 className="text-2xl font-serif font-bold">Examination Cell</h2>
                                </div>
                                <p className="text-blue-100 leading-relaxed mb-6">
                                    The Examination Cell ensures the smooth conduct of exams for thousands of students across multiple disciplines and affiliated colleges.
                                </p>
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-8">
                                    {[
                                        { label: 'Exams/Year', value: '2+' },
                                        { label: 'Courses', value: '50+' },
                                        { label: 'Results', value: 'Timely' },
                                    ].map((stat, idx) => (
