  ...
  return (
    <>
      ...
      >
        ...
        {!isScrolled && (
          <div className="absolute left-[19px] top-1/2 -translate-y-1/2 z-20 flex items-center">
            <img
              src="/panditji.png"
            ...
            />
            <div className="flex flex-col justify-center text-left font-bold text-black transition-all duration-300 leading-tight whitespace-nowrap w-auto opacity-100 ml-3">
